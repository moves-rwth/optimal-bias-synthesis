...
// on top of Herman's self stabilising algorithm [Her90]
...
module process1
    ...
    // Step
	[step] (c=1 & x1!=x0) -> (x1'=x0);
	[step] (c=1 & x1=x0 & m1=0) -> r : (x1'=0) + 1-r : (x1'=1);
	[step] (c=1 & x1=x0 & m1=2) -> (x1'=x0);
...
module process0 = process1 [ x1=x0, x0=x10, m1=m0 ] endmodule
